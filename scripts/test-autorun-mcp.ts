...
async function testMCPServer() {
  ...
  try {
    ...
    const { autorunPlan } = await import('../packages/autorun-core/src/mcp-server/tools/autorunPlan.js');
    const { autorunApply } = await import('../packages/autorun-core/src/mcp-server/tools/autorunApply.js');
    const { autorunVerify } = await import('../packages/autorun-core/src/mcp-server/tools/autorunVerify.js');
