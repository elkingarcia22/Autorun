...
function main() {
	...
	const lightTokens = extractTokens(sColorsLight.color || {}, '', 'light', pColors, sColorsLight);
	...
	const darkTokens = extractTokens(sColorsDark.color || {}, '', 'dark', pColors, sColorsDark);
	...
	fs.writeFileSync(outputFile, JSON.stringify(allTokens, null, 2), 'utf8');
