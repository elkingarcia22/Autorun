...
(() => {
	...
	function f(l) {
		for (var c = 1; c < arguments.length; c++) {
			...
			c % 2
				? z(Object(s), !0).forEach(function (c) {
						e(l, c, s[c]);
					})
				: Object.getOwnPropertyDescriptors
					? Object.defineProperties(l, Object.getOwnPropertyDescriptors(s))
					: z(Object(s)).forEach(function (c) {
			...
			((c, l) => {
				...
				if (c)
					return 'string' == typeof c
						...
						: 'Map' ===
									(s =
										'Object' === (s = {}.toString.call(c).slice(8, -1)) && c.constructor
											? c.constructor.name
											: s) || 'Set' === s
							? Array.from(c)
	...
	var l = {
					...
					e(
						e(
							e(
								e(
									e(
										e(e(e((s = {}), t, 'Classic'), 'duotone', 'Duotone'), 'sharp', 'Sharp'),
										'sharp-duotone',
										'Sharp Duotone',
									),
									'chisel',
			...
			e(
				e(
					e(
						e(
							e(
								e(e(e(s, 'notdog-duo', 'Notdog Duo'), 'slab', 'Slab'), 'slab-press', 'Slab Press'),
								'thumbprint',
								'Thumbprint',
							),
							'utility',
		...
		o = (e(e({}, 'kit', 'Kit'), 'kit-duotone', 'Kit Duotone'), { kit: 'fak' }),
		M = { 'kit-duotone': 'fakd' },
		L = 'duotone-group',
		n = 'swap-opacity',
		m = 'primary',
					...
					e(
						e(
							e(
								e(
									e(
										e(e(e((u = {}), 'classic', 'Classic'), 'duotone', 'Duotone'), 'sharp', 'Sharp'),
										'sharp-duotone',
										'Sharp Duotone',
									),
									'chisel',
			...
			e(
				e(
					e(
						e(
							e(
								e(e(e(u, 'notdog-duo', 'Notdog Duo'), 'slab', 'Slab'), 'slab-press', 'Slab Press'),
								'thumbprint',
								'Thumbprint',
							),
							'utility',
	...
	((m = f({}, l))[t] = f(f(f(f({}, { 'fa-duotone': 'duotone' }), l[t]), s), i)),
		b(m),
		((d = f(
			{},
			{
	...
	function y(c, l, s) {
		var a = (2 < arguments.length && void 0 !== s ? s : {}).skipHooks,
			a = void 0 !== a && a,
			e = p(l);
		'function' != typeof C.hooks.addPack || a
			? (C.styles[c] = f(f({}, C.styles[c] || {}), e))
			: C.hooks.addPack(c, p(l)),
			'fas' === c && y('fa', l);
	}
	var k = {
		'square-minus': [
