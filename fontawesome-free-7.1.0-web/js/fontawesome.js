...
(function () {
					...
					_defineProperty(
						_defineProperty(
							_defineProperty(
								_defineProperty(
									_defineProperty(
										_defineProperty(_defineProperty(_defineProperty(_dt, i, b), t, c), d, I),
										l,
										F,
									),
									f,
			...
			_defineProperty(
				_defineProperty(
					_defineProperty(
						_defineProperty(
							_defineProperty(
								_defineProperty(_defineProperty(_defineProperty(_dt, s, N), y, k), m, D),
								e,
								T,
							),
							p,
						...
						_defineProperty(
							_defineProperty(
								_defineProperty(
									_defineProperty(
										_defineProperty(
											_defineProperty(_defineProperty(_ml, n$1, F$1), o$1, v$1),
											u$1,
											S$1,
										),
										s$1,
	...
	var FONT_FAMILY_WEIGHT_TO_PREFIX = Object.keys(_FONT_FAMILY_WEIGHT_TO_PREFIX).reduce(function (
		acc,
		key,
	) {
	...
	var FONT_FAMILY_WEIGHT_FALLBACK = Object.keys(FONT_FAMILY_WEIGHT_TO_PREFIX).reduce(function (
		acc,
		fontFamily,
	) {
