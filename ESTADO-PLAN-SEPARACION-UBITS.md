...
- ✅ **2.1: Templates** - `packages/addons/design/templates-admin/` y `templates-colaborador/`
- ✅ **2.2: Tokens** - `packages/addons/design/tokens/` (genérico Autoframe)
- ✅ **2.3: Typography** - `packages/addons/design/typography/` (genérico Autoframe)
...
**Estado:** Los componentes UBITS originales existen en `packages/addons/` (button, sidebar, input, alert, toast) y pueden quedarse como están.

**Falta crear versiones genéricas de Autoframe:**
- ❌ `packages/addons/components/button-generic/` (genérico Autoframe)
- ❌ `packages/addons/components/input-generic/` (genérico Autoframe)
- ❌ `packages/addons/components/alert-generic/` (genérico Autoframe)
- ❌ Y otros componentes genéricos según necesidad

---

### FASE 2.5: Storybook Genérico de Autoframe
**Estado:** Ya existe `packages/addons/functional/storybook/` (genérico de Autoframe) pero puede necesitar mejoras.
...
Arreglar los errores menores en `packages/addons/design/tokens/` antes de continuar
