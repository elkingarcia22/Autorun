...
export function createSlider(options: SliderOptions): {
	...
	const sliderElement =
		(container.querySelector(`#${containerId}`) as HTMLDivElement) ||
		(container.querySelector('.ubits-slider') as HTMLDivElement);
	...
	const createInputs = () => {
		...
		if (isRange) {
			...
			let inputMinContainer: HTMLElement | null = sliderElement.querySelector(
				`#${inputMinContainerId}`,
			) as HTMLElement | null;
			...
			let inputMaxContainer: HTMLElement | null = sliderElement.querySelector(
				`#${inputMaxContainerId}`,
			) as HTMLElement | null;
			...
			let inputValueContainer: HTMLElement | null = sliderElement.querySelector(
