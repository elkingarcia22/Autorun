...
class h extends HTMLElement {
	...
	setValue(t) {
		this.sliderInstance &&
			(this.sliderInstance.setValue(t),
			this.options.mode === 'range' && Array.isArray(t)
				? this.setAttribute('values', JSON.stringify(t))
				: typeof t == 'number' && this.setAttribute('value', t.toString()));
	}
	disable() {
...
typeof window < 'u' &&
	...
	customElements.define('ubits-slider', h);
export { h as UBITSSlider };
