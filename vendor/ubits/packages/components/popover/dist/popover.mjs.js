...
function g(r) {
	const {
		...
		u = `ubits-popover--tail-${d}`,
		b = ['ubits-popover', t, u, c].filter(Boolean).join(' '),
		m = `
...
function P(r) {
	...
	if (r.footerButtons) {
		const o = t.querySelector('.ubits-popover__footer-left .ubits-popover__footer-button'),
			...
			l = t.querySelector('.ubits-popover__footer-right .ubits-button--primary');
		o &&
...
export { P as createPopover, g as renderPopover };
