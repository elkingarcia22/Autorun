...
function C(e) {
	const { containerId: i, onClose: l, closeOnOverlayClick: r = !0, open: f = !1 } = e;
	let s;
	...
	if ((document.addEventListener('keydown', v), e.footerButtons)) {
		const o = t.querySelector('.ubits-modal__footer-left .ubits-modal__footer-button'),
			d = t.querySelector('.ubits-modal__footer-right .ubits-button--secondary'),
...
typeof window < 'u' &&
	((window.createModal = C),
	(window.renderModal = _),
	window.UBITSModal || (window.UBITSModal = {}),
	(window.UBITSModal.createModal = C),
	(window.UBITSModal.renderModal = _));
export { C as createModal, _ as renderModal };
