function v(e) {
  ...
  let d = "";
  if (a || c) {
    const s = a ? `<button class="ubits-button ubits-button--primary ubits-button--md" data-action="primary" type="button">${a}</button>` : "", y = c ? `<button class="ubits-button ubits-button--secondary ubits-button--md" data-action="secondary" type="button">${c}</button>` : "";
    (s || y) && (d = `
...
export {
  A as createEmptyState,
  v as renderEmptyState
};
