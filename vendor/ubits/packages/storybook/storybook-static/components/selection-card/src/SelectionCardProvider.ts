	...
	setTimeout(() => {
		...
		const tokens = {
			'--modifiers-normal-color-light-border-1':
				rootStyle.getPropertyValue('--modifiers-normal-color-light-border-1').trim() ||
				'NO ENCONTRADO',
			'--modifiers-static-inverted-color-light-accent-brand':
				rootStyle.getPropertyValue('--modifiers-static-inverted-color-light-accent-brand').trim() ||
				'NO ENCONTRADO',
			'--modifiers-normal-color-light-bg-1':
				rootStyle.getPropertyValue('--modifiers-normal-color-light-bg-1').trim() || 'NO ENCONTRADO',
			'--ubits-spacing-lg':
				rootStyle.getPropertyValue('--ubits-spacing-lg').trim() || 'NO ENCONTRADO',
			'--ubits-spacing-sm':
				rootStyle.getPropertyValue('--ubits-spacing-sm').trim() || 'NO ENCONTRADO',
			'--ubits-border-radius-md':
				rootStyle.getPropertyValue('--ubits-border-radius-md').trim() || 'NO ENCONTRADO',
			'--font-body-md-size':
				rootStyle.getPropertyValue('--font-body-md-size').trim() || 'NO ENCONTRADO',
			'--font-body-md-line':
				rootStyle.getPropertyValue('--font-body-md-line').trim() || 'NO ENCONTRADO',
			'--weight-semibold':
				rootStyle.getPropertyValue('--weight-semibold').trim() || 'NO ENCONTRADO',
