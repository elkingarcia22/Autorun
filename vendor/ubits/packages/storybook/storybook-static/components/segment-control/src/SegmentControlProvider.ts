...
function initSegmentListeners(segmentsElement: HTMLElement, options: SegmentControlOptions): void {
	...
	const existingSegments = segmentsElement.querySelectorAll<HTMLElement>(
	...
	const segments = segmentsElement.querySelectorAll<HTMLElement>(
 ...
 */
export function createSegmentControl(
