 ...
 */
export declare function renderSpinner(options?: SpinnerOptions): string;
/**
 * Crea un elemento spinner programáticamente
 */
export declare function createSpinner(options?: SpinnerOptions): HTMLDivElement;
//# sourceMappingURL=SpinnerProvider.d.ts.map
