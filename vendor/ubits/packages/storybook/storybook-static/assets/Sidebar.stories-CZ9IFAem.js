import"./iframe-BcZai5-G.js";import"./preload-helper-PPVm8Dsz.js";function w(e,t="regular"){const o=t==="regular"?"far":"fas",n=e.startsWith("fa-")?e:`fa-${e}`;return`<i class="${o} ${n}"></i>`}function E(e){const t=window.innerHeight,o=16,r=t-o-16,l=Math.max(578,r);e.style.height=`${l}px`,e.style.top=`${o}px`}function M(e){const{variant:t="colaborador",bodyButtons:o,footerButtons:n=[],logoHref:r,logoImage:d="images/Ubits-logo.svg",profileMenuItems:l=[],avatarImage:i="images/Profile-image.jpg",darkModeEnabled:s=!0,className:f="",attributes:p={}}=e,c=r||(t==="admin"?"admin.html":"index.html"),u=["ubits-sidebar",f].filter(Boolean).join(" "),g=Object.entries(p).map(([a,v])=>`${a}="${v}"`).join(" "),m=o.map(a=>{const v=["ubits-sidebar-nav-button",a.state==="active"?"active":"",a.state==="disabled"?"disabled":""].filter(Boolean).join(" "),y=a.onClick?'data-has-click-handler="true"':"",B=a.href?`data-href="${a.href}"`:"";return`
      <button 
        class="${v}" 
