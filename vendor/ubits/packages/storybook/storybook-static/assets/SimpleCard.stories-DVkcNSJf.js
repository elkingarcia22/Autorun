import { c as l } from './simple-card-CrYdjRkL.js';
...
const s = [
	...
	n = ['ubits-heading-h1', 'ubits-heading-h2', 'ubits-body-lg', 'ubits-body-md', 'ubits-body-sm'],
	T = {
		...
		argTypes: {
			...
			paddingToken: {
				...
				table: { type: { summary: 'CSS Variable' }, category: 'Tokens - Espaciado' },
			},
			borderRadiusToken: {
				control: { type: 'select' },
				options: c,
				description: 'Token de border radius para la card',
				table: { type: { summary: 'CSS Variable' }, category: 'Tokens - Border Radius' },
			},
			...
			showButtons: {
				...
				table: { defaultValue: { summary: 'true' }, category: 'Botones' },
			},
			button1Label: {
				control: { type: 'text' },
				description: 'Texto del primer botón',
				table: { defaultValue: { summary: 'Cancel' }, category: 'Botones' },
			},
			button1Variant: {
				control: { type: 'select' },
				options: ['primary', 'secondary', 'tertiary'],
				description: 'Variante del primer botón',
				table: { defaultValue: { summary: 'secondary' }, category: 'Botones' },
			},
			button1Size: {
				control: { type: 'select' },
				options: ['xs', 'sm', 'md', 'lg'],
				description: 'Tamaño del primer botón',
				table: { defaultValue: { summary: 'md' }, category: 'Botones' },
			},
			button2Label: {
				control: { type: 'text' },
				description: 'Texto del segundo botón',
				table: { defaultValue: { summary: 'Save' }, category: 'Botones' },
			},
			button2Variant: {
				control: { type: 'select' },
				options: ['primary', 'secondary', 'tertiary'],
				description: 'Variante del segundo botón',
				table: { defaultValue: { summary: 'primary' }, category: 'Botones' },
			},
			button2Size: {
				control: { type: 'select' },
				options: ['xs', 'sm', 'md', 'lg'],
...
function p(e) {
	...
	return (
		e.showButtons !== !1 &&
			(e.button1Label &&
				o.push({
					label: e.button1Label,
					variant: e.button1Variant || 'secondary',
					size: e.button1Size || 'md',
				}),
			e.button2Label &&
				o.push({
					label: e.button2Label,
					variant: e.button2Variant || 'primary',
					size: e.button2Size || 'md',
				})),
		{
			title: e.title || 'Advanced Card',
			subtitle: e.subtitle || 'Card subtitle',
			content:
				e.content ||
				'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore sed consequuntur error repudiandae numquam deserunt quisquam repellat libero asperiores earum nam nobis, culpa ratione quam perferendis esse, cupiditate neque quas!',
			showHeader: e.showHeader !== !1,
			headerDecorations: e.headerDecorations !== !1,
			headerBackground: e.headerBackgroundToken || 'var(--modifiers-normal-color-light-bg-4)',
			backgroundColor: e.backgroundColorToken || 'var(--modifiers-normal-color-light-bg-1)',
			borderColor: e.borderColorToken || 'var(--modifiers-normal-color-light-border-1)',
			titleTypography: e.titleTypographyClass || 'ubits-heading-h2',
			subtitleTypography: e.subtitleTypographyClass || 'ubits-body-md',
			contentTypography: e.contentTypographyClass || 'ubits-body-md',
			buttons: o.length > 0 ? o : void 0,
			showButtons: e.showButtons !== !1,
...
const a = {
	...
	render: (e) => {
		...
		(r.style.width = '100%'), (r.style.display = 'flex'), (r.style.justifyContent = 'center');
		const i = l(o);
		return r.appendChild(i), t.appendChild(r), t;
	},
};
a.parameters = {
	...a.parameters,
...
const v = ['Default'];
export { a as Default, v as __namedExportsOrder, T as default };
