import { r as m } from './CheckboxProvider-DIr0OIhT.js';
		...
		render: (e) => {
			...
			const o = () => {
				const t = m({
					...
					value: e.value,
					name: e.name,
					checked: e.checked !== void 0 ? e.checked : !1,
					indeterminate: e.indeterminate !== void 0 ? e.indeterminate : !1,
					size: e.size || 'md',
				...
				n.innerHTML = t;
				const r = n.querySelector('.ubits-checkbox__input');
				r &&
					(e.indeterminate && (r.indeterminate = !0),
					e.onChange &&
			...
			const c = setInterval(() => {
				...
				i = new MutationObserver(() => {
					document.body.contains(n) || (l(), i.disconnect());
				});
			return i.observe(document.body, { childList: !0, subtree: !0 }), n;
		},
	};
a.parameters = {
	...a.parameters,
...
const f = ['Default'];
export { a as Default, f as __namedExportsOrder, y as default };
