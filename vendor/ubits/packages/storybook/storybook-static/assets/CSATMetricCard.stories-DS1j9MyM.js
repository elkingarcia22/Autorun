import{r as p}from"./ButtonProvider-Dmy-L2BE.js";import"./iframe-BcZai5-G.js";import"./ListProvider-Bx601uSc.js";import"./SpinnerProvider-o6XHV06V.js";import"./preload-helper-PPVm8Dsz.js";function S(a,e="regular",t){const s=e==="solid"?"fas":"far",o=a.startsWith("fa-")?a:`fa-${a}`,r=t?`style="color: ${t};"`:"";return`<i class="${s} ${o}" ${r}></i>`}const L=[{icon:"face-angry",label:"Muy malo",color:"var(--ubits-feedback-accent-error)"},{icon:"face-sad-tear",label:"Malo",color:"var(--ubits-feedback-fg-warning-subtle-hover)"},{icon:"face-meh",label:"Regular",color:"var(--ubits-feedback-accent-info)"},{icon:"face-smile",label:"Bueno",color:"var(--ubits-feedback-accent-success)"},{icon:"face-smile-beam",label:"Muy bueno",color:"var(--ubits-feedback-accent-success)"}];function H(a){const t=Math.round(a),s=Math.min(Math.max(t-1,0),4);let o="";for(let r=0;r<5;r++){const c=L[r],n=r===s,l=n?"ubits-csat-metric-card__face ubits-csat-metric-card__face--selected":"ubits-csat-metric-card__face ubits-csat-metric-card__face--empty",d=n?c.color:"var(--modifiers-normal-color-light-border-1)";o+=`
