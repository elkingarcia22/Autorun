import { r as u } from './RadioButtonProvider-CIXtywXC.js';
	...
	a = {
		...
		render: (e) => {
			...
			const o = () => {
				...
				t.innerHTML = n;
				const l = t.querySelector('.ubits-radio-button__input');
				l &&
					e.onChange &&
					l.addEventListener('change', (c) => {
						e.onChange && e.onChange(c);
					});
			};
			o();
			...
			const i = setInterval(() => {
				...
				s = new MutationObserver(() => {
					document.body.contains(t) || (d(), s.disconnect());
				});
			return s.observe(document.body, { childList: !0, subtree: !0 }), t;
		},
	};
a.parameters = {
	...a.parameters,
...
const g = ['Default'];
export { a as Default, g as __namedExportsOrder, b as default };
