import{r as $}from"./ButtonProvider-Dmy-L2BE.js";const g={sm:"240px",md:"360px",lg:"400px",xl:"480px"};function h(s){const{title:a,bodyContent:n="",width:f="md",tailPosition:c="top",tailOffset:e=0,footerButtons:l,className:d=""}=s,v=g[f]||g.md,t=`ubits-popover--width-${f}`,u=`ubits-popover--tail-${c}`,y=["ubits-popover",t,u,d].filter(Boolean).join(" "),m=`
