import { c as s } from './PaginationProvider-DjGMqkqy.js';
	...
	n = {
		render: (a) => {
			...
			const i = {
				...
				containerId: t,
				onPageChange: (o) => {
					const r = { ...a, currentPage: o, containerId: t };
					s(r);
				},
				onItemsPerPageChange: (o) => {
					const r = { ...a, itemsPerPage: o, currentPage: 1, containerId: t };
					s(r);
				},
			};
			return (
...
const P = ['Default'];
export { n as Default, P as __namedExportsOrder, g as default };
