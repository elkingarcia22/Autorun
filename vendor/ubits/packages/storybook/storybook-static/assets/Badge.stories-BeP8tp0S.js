import { r as l } from './BadgeProvider-DQRLkCrk.js';
const b = {
		title: 'Básicos/Badge',
		tags: ['autodocs'],
		parameters: {
		...
		argTypes: {
			type: {
				...
				table: { defaultValue: { summary: 'number' }, type: { summary: 'dot | number' } },
			},
			variant: {
				control: { type: 'select' },
			...
			style: {
				...
				description:
					'Estilo del badge: light (sin borde), neutral (con borde gris) o bold (fondo de color)',
				table: { defaultValue: { summary: 'light' }, type: { summary: 'light | neutral | bold' } },
			},
			size: {
				control: { type: 'select' },
				options: ['xs', 'sm', 'md', 'lg'],
			...
			labelTypography: {
				...
				table: {
					...
					type: {
						summary:
							'ubits-body-sm-regular | ubits-body-sm-semibold | ubits-body-sm-bold | ubits-body-md-regular | ubits-body-md-semibold | ubits-body-md-bold | ubits-heading-h1 | ubits-heading-h2',
					},
				},
			},
		},
	...
	i = {
		...
		render: (a) => {
			...
			(r.style.padding = '20px'),
				(r.style.background = 'var(--modifiers-normal-color-light-bg-1, #ffffff)'),
			...
			(e.style.display = 'flex'),
				...
				(e.style.background = 'var(--modifiers-normal-color-light-bg-2, #f9fafb)'),
			...
			if (
				...
				(o.style.color = 'var(--modifiers-normal-color-light-fg-1-high, #303a47)'),
				(o.innerHTML = l(a)),
				a.absolute)
			) {
				...
				(t.style.position = 'relative'),
					...
					(t.innerHTML = '<span style="font-size: 14px;">Elemento con badge</span>'),
					(t.innerHTML += l(a)),
					(o.innerHTML = ''),
					o.appendChild(t);
			}
			return (
				...
				r.appendChild(e),
				setTimeout(() => {
					const t = r.querySelectorAll('.ubits-badge');
					document.documentElement.getAttribute('data-theme'),
						a.style,
						t.forEach((n, s) => {
							n.querySelector('.ubits-badge__dot--number'),
								n.querySelector('.ubits-badge__number-text'),
								n.querySelector('span:not(.ubits-badge__dot)');
						});
				}, 100),
				r
			);
