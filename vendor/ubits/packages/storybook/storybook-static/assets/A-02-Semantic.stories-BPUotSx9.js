import { c as p, a as q } from './utils-QDDdDBjb.js';
const e = {
		feedback: {
			accent: {
				light: [
	...
	X = {
		...
		parameters: {
			...
			docs: {
				description: {
					component:
						'Colores semánticos del sistema UBITS. Incluye colores de feedback (success, error, warning, info), colores de marca (brand) y colores para gráficos (chart).',
				},
			},
		},
	},
	K = {
		render: () => {
			...
			(l.style.padding = '24px'), (l.style.maxWidth = '1400px');
			const i = document.createElement('h2');
			(i.textContent = 'Semánticos - Todos los Tokens'),
				(i.style.fontSize = '24px'),
				(i.style.fontWeight = '700'),
				(i.style.marginBottom = '16px'),
				l.appendChild(i);
			const c =
					e.feedback.accent.light.length +
					e.feedback.border.light.length +
					e.feedback.chart.light.length,
				o = e.brand.light.length,
				n = e.chart.length,
    ...
    `),
			...
			(r.textContent = 'Feedback'),
				...
				(r.style.paddingBottom = '8px'),
				(r.style.borderBottom = '2px solid #e5e7eb'),
				d.appendChild(r);
			const s = document.createElement('div');
			s.style.marginBottom = '24px';
			const w = document.createElement('h4');
			(w.textContent = `Accent (${e.feedback.accent.light.length} tokens Light + ${e.feedback.accent.dark.length} tokens Dark)`),
				(w.style.fontSize = '18px'),
				(w.style.fontWeight = '600'),
				(w.style.marginBottom = '12px'),
				s.appendChild(w);
			const g = document.createElement('div');
			(g.style.display = 'grid'), (g.style.gridTemplateColumns = '1fr 1fr'), (g.style.gap = '16px');
			const u = document.createElement('div');
			(u.style.background = '#ffffff'),
				(u.style.border = '1px solid #e5e7eb'),
				(u.style.borderRadius = '10px'),
				(u.style.padding = '16px');
			...
			(T.textContent = 'Light Mode'),
				...
				u.appendChild(T),
				e.feedback.accent.light.forEach((a) => {
					u.appendChild(p(a, 'light', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				g.appendChild(u);
			const f = document.createElement('div');
			(f.style.background = '#0E1825'),
				(f.style.color = '#edeeef'),
				(f.style.border = '1px solid #0E1825'),
				(f.style.borderRadius = '10px'),
				(f.style.padding = '16px');
			const m = document.createElement('h5');
			(m.textContent = 'Dark Mode'),
				(m.style.fontSize = '14px'),
				(m.style.fontWeight = '600'),
				(m.style.marginBottom = '12px'),
				(m.style.color = '#edeeef'),
				f.appendChild(m),
				e.feedback.accent.dark.forEach((a) => {
					f.appendChild(p(a, 'dark', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				g.appendChild(f),
				s.appendChild(g),
				d.appendChild(s);
			...
			(B.textContent = `Border (${e.feedback.border.light.length} tokens Light + ${e.feedback.border.dark.length} tokens Dark)`),
				(B.style.fontSize = '18px'),
				(B.style.fontWeight = '600'),
				(B.style.marginBottom = '12px'),
				D.appendChild(B);
			const k = document.createElement('div');
			(k.style.display = 'grid'), (k.style.gridTemplateColumns = '1fr 1fr'), (k.style.gap = '16px');
			...
			(E.textContent = 'Light Mode'),
				...
				C.appendChild(E),
				e.feedback.border.light.forEach((a) => {
					C.appendChild(p(a, 'light', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				k.appendChild(C);
			const y = document.createElement('div');
			(y.style.background = '#0E1825'),
				(y.style.color = '#edeeef'),
				(y.style.border = '1px solid #0E1825'),
				(y.style.borderRadius = '10px'),
				(y.style.padding = '16px');
			const b = document.createElement('h5');
			(b.textContent = 'Dark Mode'),
				(b.style.fontSize = '14px'),
				(b.style.fontWeight = '600'),
				(b.style.marginBottom = '12px'),
				(b.style.color = '#edeeef'),
				y.appendChild(b),
				e.feedback.border.dark.forEach((a) => {
					y.appendChild(p(a, 'dark', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				k.appendChild(y),
				D.appendChild(k),
				d.appendChild(D);
			...
			(h.textContent = `Chart (${e.feedback.chart.light.length} tokens Light + ${e.feedback.chart.dark.length} tokens Dark)`),
				(h.style.fontSize = '18px'),
				(h.style.fontWeight = '600'),
				(h.style.marginBottom = '12px'),
				L.appendChild(h);
			const V = document.createElement('div');
			(V.style.display = 'grid'), (V.style.gridTemplateColumns = '1fr 1fr'), (V.style.gap = '16px');
			const v = document.createElement('div');
			(v.style.background = '#ffffff'),
				(v.style.border = '1px solid #e5e7eb'),
				(v.style.borderRadius = '10px'),
				(v.style.padding = '16px');
			const R = document.createElement('h5');
			(R.textContent = 'Light Mode'),
				(R.style.fontSize = '14px'),
				(R.style.fontWeight = '600'),
				(R.style.marginBottom = '12px'),
				v.appendChild(R),
				e.feedback.chart.light.forEach((a) => {
					v.appendChild(p(a, 'light', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				V.appendChild(v);
			const z = document.createElement('div');
			(z.style.background = '#0E1825'),
				(z.style.color = '#edeeef'),
				(z.style.border = '1px solid #0E1825'),
			...
			($.textContent = 'Dark Mode'),
				...
				($.style.color = '#edeeef'),
				z.appendChild($),
				e.feedback.chart.dark.forEach((a) => {
					z.appendChild(p(a, 'dark', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				V.appendChild(z),
				L.appendChild(V),
				d.appendChild(L),
			...
			(F.textContent = `Brand (${e.brand.light.length} tokens Light + ${e.brand.dark.length} tokens Dark)`),
				(F.style.fontSize = '20px'),
				(F.style.fontWeight = '600'),
				(F.style.marginBottom = '16px'),
				(F.style.paddingBottom = '8px'),
				(F.style.borderBottom = '2px solid #e5e7eb'),
				j.appendChild(F);
			const O = document.createElement('div');
			(O.style.display = 'grid'), (O.style.gridTemplateColumns = '1fr 1fr'), (O.style.gap = '16px');
			...
			(I.textContent = 'Light Mode'),
				(I.style.fontSize = '14px'),
				(I.style.fontWeight = '600'),
				(I.style.marginBottom = '12px'),
				M.appendChild(I),
				e.brand.light.forEach((a) => {
					M.appendChild(p(a, 'light', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				O.appendChild(M);
			const N = document.createElement('div');
			(N.style.background = '#0E1825'),
				(N.style.color = '#edeeef'),
				(N.style.border = '1px solid #0E1825'),
			...
			(A.textContent = 'Dark Mode'),
				...
				(A.style.color = '#edeeef'),
				N.appendChild(A),
				e.brand.dark.forEach((a) => {
					N.appendChild(p(a, 'dark', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				O.appendChild(N),
				j.appendChild(O),
				l.appendChild(j);
			...
			(W.textContent = `Chart (${e.chart.length} tokens)`),
				(W.style.fontSize = '20px'),
				(W.style.fontWeight = '600'),
				(W.style.marginBottom = '16px'),
				(W.style.paddingBottom = '8px'),
				(W.style.borderBottom = '2px solid #e5e7eb'),
				H.appendChild(W);
			const S = {
				Foreground: [],
				Blue: [],
			...
			return (
				e.chart.forEach((a) => {
					...
					x.includes('fg')
						? S.Foreground.push(a)
						: x.includes('neutral-blue')
							? S['Neutral Blue'].push(a)
							: x.includes('blue')
								? S.Blue.push(a)
								: x.includes('gray')
									? S.Gray.push(a)
				...
				Object.entries(S).forEach(([a, x]) => {
					if (x.length === 0) return;
					const U = document.createElement('div');
					U.style.marginBottom = '24px';
					const _ = document.createElement('h4');
					(_.textContent = `${a} (${x.length} tokens)`),
						(_.style.fontSize = '18px'),
						(_.style.fontWeight = '600'),
						(_.style.marginBottom = '12px'),
						U.appendChild(_);
					const J = q(x, a);
					U.appendChild(J), H.appendChild(U);
				}),
				l.appendChild(H),
				l
			);
	...
	G = {
		render: () => {
			...
			(l.style.padding = '24px'), (l.style.maxWidth = '1400px');
			const i = document.createElement('h2');
			(i.textContent = 'Feedback Colors'),
				(i.style.fontSize = '24px'),
				(i.style.fontWeight = '700'),
				(i.style.marginBottom = '16px'),
				l.appendChild(i);
			const c = document.createElement('div');
			c.style.marginBottom = '32px';
			const o = document.createElement('h3');
			(o.textContent = `Accent (${e.feedback.accent.light.length} tokens Light + ${e.feedback.accent.dark.length} tokens Dark)`),
				(o.style.fontSize = '20px'),
				(o.style.fontWeight = '600'),
				(o.style.marginBottom = '16px'),
				(o.style.paddingBottom = '8px'),
				(o.style.borderBottom = '2px solid #e5e7eb'),
				c.appendChild(o);
			const n = document.createElement('div');
			(n.style.display = 'grid'), (n.style.gridTemplateColumns = '1fr 1fr'), (n.style.gap = '16px');
			...
			(d.textContent = 'Light Mode'),
				(d.style.fontSize = '16px'),
				(d.style.fontWeight = '600'),
				(d.style.marginBottom = '12px'),
				t.appendChild(d),
				e.feedback.accent.light.forEach((h) => {
					t.appendChild(p(h, 'light', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				n.appendChild(t);
			const r = document.createElement('div');
			(r.style.background = '#0E1825'),
				(r.style.color = '#edeeef'),
				(r.style.border = '1px solid #0E1825'),
				(r.style.borderRadius = '10px'),
				(r.style.padding = '16px');
			const s = document.createElement('h4');
			(s.textContent = 'Dark Mode'),
				(s.style.fontSize = '16px'),
				(s.style.fontWeight = '600'),
				(s.style.marginBottom = '12px'),
				(s.style.color = '#edeeef'),
				r.appendChild(s),
				e.feedback.accent.dark.forEach((h) => {
					r.appendChild(p(h, 'dark', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				n.appendChild(r),
				c.appendChild(n),
				l.appendChild(c);
			...
			(g.textContent = `Border (${e.feedback.border.light.length} tokens Light + ${e.feedback.border.dark.length} tokens Dark)`),
				(g.style.fontSize = '20px'),
				(g.style.fontWeight = '600'),
				(g.style.marginBottom = '16px'),
				(g.style.paddingBottom = '8px'),
				(g.style.borderBottom = '2px solid #e5e7eb'),
				w.appendChild(g);
			const u = document.createElement('div');
			(u.style.display = 'grid'), (u.style.gridTemplateColumns = '1fr 1fr'), (u.style.gap = '16px');
			const T = document.createElement('div');
			(T.style.background = '#ffffff'),
				(T.style.border = '1px solid #e5e7eb'),
				(T.style.borderRadius = '10px'),
			...
			(f.textContent = 'Light Mode'),
				(f.style.fontSize = '16px'),
				(f.style.fontWeight = '600'),
				(f.style.marginBottom = '12px'),
				T.appendChild(f),
				e.feedback.border.light.forEach((h) => {
					T.appendChild(p(h, 'light', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				u.appendChild(T);
			const m = document.createElement('div');
			(m.style.background = '#0E1825'),
				(m.style.color = '#edeeef'),
				(m.style.border = '1px solid #0E1825'),
				(m.style.borderRadius = '10px'),
				(m.style.padding = '16px');
			const D = document.createElement('h4');
			(D.textContent = 'Dark Mode'),
				(D.style.fontSize = '16px'),
				(D.style.fontWeight = '600'),
				(D.style.marginBottom = '12px'),
				(D.style.color = '#edeeef'),
				m.appendChild(D),
				e.feedback.border.dark.forEach((h) => {
					m.appendChild(p(h, 'dark', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				u.appendChild(m),
				w.appendChild(u),
				l.appendChild(w);
			const B = document.createElement('div');
			B.style.marginBottom = '32px';
			const k = document.createElement('h3');
			(k.textContent = `Chart (${e.feedback.chart.light.length} tokens Light + ${e.feedback.chart.dark.length} tokens Dark)`),
				(k.style.fontSize = '20px'),
				(k.style.fontWeight = '600'),
				(k.style.marginBottom = '16px'),
				(k.style.paddingBottom = '8px'),
				(k.style.borderBottom = '2px solid #e5e7eb'),
				B.appendChild(k);
			const C = document.createElement('div');
			(C.style.display = 'grid'), (C.style.gridTemplateColumns = '1fr 1fr'), (C.style.gap = '16px');
			...
			(y.textContent = 'Light Mode'),
				(y.style.fontSize = '16px'),
				(y.style.fontWeight = '600'),
				(y.style.marginBottom = '12px'),
				E.appendChild(y),
				e.feedback.chart.light.forEach((h) => {
					E.appendChild(p(h, 'light', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				C.appendChild(E);
			const b = document.createElement('div');
			(b.style.background = '#0E1825'),
				(b.style.color = '#edeeef'),
				(b.style.border = '1px solid #0E1825'),
			...
			return (
				...
				(L.style.color = '#edeeef'),
				b.appendChild(L),
				e.feedback.chart.dark.forEach((h) => {
					b.appendChild(p(h, 'dark', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				C.appendChild(b),
				B.appendChild(C),
				l.appendChild(B),
	...
	P = {
		render: () => {
			...
			(c.style.marginBottom = '16px'),
				...
				(c.textContent = `Total: ${e.brand.light.length} tokens Light + ${e.brand.dark.length} tokens Dark`),
				l.appendChild(c);
			const o = document.createElement('div');
			(o.style.display = 'grid'), (o.style.gridTemplateColumns = '1fr 1fr'), (o.style.gap = '16px');
			const n = document.createElement('div');
			...
			(t.textContent = 'Light Mode'),
				...
				(t.style.marginBottom = '12px'),
				n.appendChild(t),
				e.brand.light.forEach((s) => {
					n.appendChild(p(s, 'light', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				o.appendChild(n);
			const d = document.createElement('div');
			(d.style.background = '#0E1825'),
				(d.style.color = '#edeeef'),
				(d.style.border = '1px solid #0E1825'),
				(d.style.borderRadius = '10px'),
				(d.style.padding = '16px');
			const r = document.createElement('h5');
			return (
				(r.textContent = 'Dark Mode'),
				(r.style.fontSize = '14px'),
				(r.style.fontWeight = '600'),
				(r.style.marginBottom = '12px'),
				(r.style.color = '#edeeef'),
				d.appendChild(r),
				e.brand.dark.forEach((s) => {
					d.appendChild(p(s, 'dark', { showVariable: !0, showValue: !0, width: '100%' }));
				}),
				o.appendChild(d),
				l.appendChild(o),
				l
	...
	Y = {
		render: () => {
			...
			(c.style.marginBottom = '16px'),
				(c.style.fontSize = '16px'),
				(c.style.fontWeight = '600'),
				(c.textContent = `Total: ${e.chart.length} tokens`),
				l.appendChild(c);
			const o = {
				Foreground: [],
				Blue: [],
			...
			return (
				e.chart.forEach((n) => {
					...
					t.includes('fg')
						? o.Foreground.push(n)
						: t.includes('neutral-blue')
							? o['Neutral Blue'].push(n)
							: t.includes('blue')
								? o.Blue.push(n)
								: t.includes('gray')
									? o.Gray.push(n)
				...
				Object.entries(o).forEach(([n, t]) => {
					...
					const d = document.createElement('div');
					d.style.marginBottom = '32px';
					const r = document.createElement('h3');
					(r.textContent = `${n} (${t.length} tokens)`),
						(r.style.fontSize = '20px'),
						(r.style.fontWeight = '600'),
						(r.style.marginBottom = '16px'),
						(r.style.paddingBottom = '8px'),
						...
						d.appendChild(r);
					const s = q(t, n);
					d.appendChild(s), l.appendChild(d);
				}),
				l
			);
		},
...
K.parameters = {
  ...
  render: () => {
    ...
    return container;
		...
		description: {
			story: 'Story principal que muestra todos los semánticos',
...
G.parameters = {
  ...
  render: () => {
    ...
    return container;
		...
		description: { story: 'Story para Feedback', ...G.parameters?.docs?.description },
	},
};
P.parameters = {
	...P.parameters,
  ...
  render: () => {
    ...
    return container;
		...
		description: { story: 'Story para Brand', ...P.parameters?.docs?.description },
	},
};
Y.parameters = {
	...Y.parameters,
  ...
  render: () => {
    ...
    return container;
		...
		description: { story: 'Story para Chart', ...Y.parameters?.docs?.description },
	},
};
const Z = ['TodosLosSemanticos', 'Feedback', 'Brand', 'Chart'];
export {
	P as Brand,
	Y as Chart,
	G as Feedback,
	K as TodosLosSemanticos,
