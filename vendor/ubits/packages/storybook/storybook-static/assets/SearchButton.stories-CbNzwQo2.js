import { r as C } from './search-button-DSrB6toq.js';
...
import './InputProvider-B1iJaViU.js';
...
const x = {
	...
	p = {
		...
		render: (e) => {
			...
			let c = e.active !== void 0 ? e.active : !1,
				r = e.value || '',
				i = e.state || 'default';
			const o = () => {
				const u = c || i === 'active',
					g = C({
						...
						size: e.size || 'md',
						state: i,
						disabled: e.disabled !== void 0 ? e.disabled : !1,
				...
				if (((a.innerHTML = g), u)) {
					const t = a.querySelector('.ubits-search-button__input'),
						s = a.querySelector('.ubits-search-button__clear');
					t &&
						(t.addEventListener('input', (n) => {
							(r = t.value), e.onChange && e.onChange(n);
							const l = a.querySelector('.ubits-search-button__clear');
                ...
                `,
										f = a.querySelector('.ubits-search-button__input-wrapper');
									if (f) {
										f.insertAdjacentHTML('beforeend', E);
										const d = a.querySelector('.ubits-search-button__clear');
										d &&
						...
						t.addEventListener('keydown', (n) => {
							n.key === 'Escape' &&
								(n.preventDefault(), n.stopPropagation(), (c = !1), (i = 'default'), o());
						}),
					...
					const t = a.querySelector('button');
					t &&
						t.addEventListener('click', (s) => {
							s.preventDefault(),
								...
								o(),
								setTimeout(() => {
									const n = a.querySelector('.ubits-search-button__input');
									n && n.focus();
								}, 50);
						});
				}
			...
			const h = setInterval(() => {
					...
					u !== m &&
						((m = u),
						e.active !== void 0 && (c = e.active),
						e.state !== void 0 && (i = e.state),
				...
				b = new MutationObserver(() => {
					document.body.contains(a) || (y(), b.disconnect());
				});
			return b.observe(document.body, { childList: !0, subtree: !0 }), a;
		},
	};
p.parameters = {
	...p.parameters,
...
const H = ['Default'];
export { p as Default, H as __namedExportsOrder, x as default };
