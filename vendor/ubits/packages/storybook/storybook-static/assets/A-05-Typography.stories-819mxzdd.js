const E = {
		...
		parameters: {
			...
			docs: {
				description: {
					component:
						'Tokens de tipografía del sistema UBITS. Incluye font-family, font-size, font-weight, line-height y letter-spacing.',
				},
			},
		},
	},
	i = {
		...
		'font-weight': ['--weight-regular', '--weight-semibold', '--weight-bold'],
		'line-height': [
			'--font-d1-line',
			'--font-d2-line',
			'--font-d3-line',
...
function H(l) {
	...
	return getComputedStyle(o).getPropertyValue(l).trim() || 'N/A';
}
function u(l, o) {
	const n = document.createElement('tr');
	n.style.borderBottom = '1px solid #e5e7eb';
	...
	(a.style.padding = '12px'), (a.style.fontSize = '14px'), (a.style.color = '#6b7280');
	const e = H(l);
	if (o === 'font-family') a.textContent = e;
	else if (o === 'font-size' || o === 'line-height') {
		const t = document.createElement('span');
		if (
			((t.textContent = e), (t.style.marginRight = '12px'), a.appendChild(t), o === 'font-size')
		) {
			const r = document.createElement('span');
			(r.textContent = 'Aa'), (r.style.fontSize = e), (r.style.color = '#303a47'), a.appendChild(r);
		}
	} else if (o === 'font-weight') {
		const t = document.createElement('span');
		(t.textContent = e), (t.style.marginRight = '12px'), a.appendChild(t);
		const r = document.createElement('span');
		(r.textContent = 'Aa'), (r.style.fontWeight = e), (r.style.color = '#303a47'), a.appendChild(r);
...
const y = {
    ...
    `),
				...
				Object.entries(i).forEach(([a, e]) => {
					...
					(r.textContent = `${a.charAt(0).toUpperCase() + a.slice(1).replace('-', ' ')} (${e.length} tokens)`),
					...
					x.style.backgroundColor = '#f9fafb';
	...
	m = {
		render: () => {
			...
			(t.textContent = 'Valor'),
				...
				(t.style.color = '#303a47'),
				(t.style.borderBottom = '2px solid #e5e7eb'),
				a.appendChild(t),
				d.appendChild(a),
				n.appendChild(d);
			const r = document.createElement('tbody');
			return (
				i['font-family'].forEach((s) => {
					r.appendChild(u(s, 'font-family'));
				}),
				n.appendChild(r),
				l.appendChild(n),
				l
	...
	h = {
		render: () => {
			...
			const r = document.createElement('tbody');
			return (
				i['font-size'].forEach((s) => {
					r.appendChild(u(s, 'font-size'));
				}),
				n.appendChild(r),
				l.appendChild(n),
				l
	...
	f = {
		render: () => {
			...
			const r = document.createElement('tbody');
			return (
				i['font-weight'].forEach((s) => {
					r.appendChild(u(s, 'font-weight'));
				}),
				n.appendChild(r),
				l.appendChild(n),
				l
	...
	b = {
		render: () => {
			...
			const r = document.createElement('tbody');
			return (
				i['line-height'].forEach((s) => {
					r.appendChild(u(s, 'line-height'));
				}),
				n.appendChild(r),
				l.appendChild(n),
				l
...
y.parameters = {
  ...
  render: () => {
    ...
    return container;
		...
		description: {
			story: 'Story principal que muestra todos los tokens de tipografía',
...
m.parameters = {
  ...
  render: () => {
    ...
    return container;
		...
		description: { story: 'Story para Font Family', ...m.parameters?.docs?.description },
	},
};
h.parameters = {
	...h.parameters,
  ...
  render: () => {
    ...
    return container;
		...
		description: { story: 'Story para Font Size', ...h.parameters?.docs?.description },
	},
};
f.parameters = {
	...f.parameters,
  ...
  render: () => {
    ...
    return container;
		...
		description: { story: 'Story para Font Weight', ...f.parameters?.docs?.description },
	},
};
b.parameters = {
	...b.parameters,
  ...
  render: () => {
    ...
    return container;
		...
		description: { story: 'Story para Line Height', ...b.parameters?.docs?.description },
	},
};
const v = ['TodosLosTokens', 'FontFamily', 'FontSize', 'FontWeight', 'LineHeight'];
export {
	m as FontFamily,
	h as FontSize,
	f as FontWeight,
