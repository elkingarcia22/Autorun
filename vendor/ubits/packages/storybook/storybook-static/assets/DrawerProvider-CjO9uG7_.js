import{r as v}from"./ButtonProvider-Dmy-L2BE.js";function p(r){const{title:l,complementaryText:i,width:f=40,bodyContent:d="",footerButtons:o,className:u=""}=r,b=["ubits-drawer",`ubits-drawer--width-${f}`,u].filter(Boolean).join(" "),n=`
