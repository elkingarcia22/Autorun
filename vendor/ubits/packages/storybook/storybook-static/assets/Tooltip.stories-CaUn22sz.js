import { c as b } from './TooltipProvider-C3qYI4Ua.js';
...
const T = {
		...
		argTypes: {
			...
			tertiaryButtonLabel: {
				...
				table: { type: { summary: 'string' }, category: 'Botón Terciario' },
			},
			showTertiaryButton: {
				control: { type: 'boolean' },
	...
	l = {
		args: {
			...
			showTitle: !0,
			description:
				'Esta es la descripción del tooltip que proporciona información adicional al usuario.',
			showDescription: !0,
			width: 'md',
			tailPosition: 'top',
			tailOffset: 0,
			...
			showTertiaryButtonIcon: !1,
			open: !0,
			closeOnOutsideClick: !0,
		},
		render: (t) => {
			const e = document.createElement('div');
			(e.id = 'tooltip-story-container'),
				(e.style.width = '100vw'),
				(e.style.height = '100vh'),
				(e.style.position = 'relative'),
				(e.style.overflow = 'hidden'),
				(e.style.background = 'var(--modifiers-normal-color-light-bg-2)'),
				(e.style.display = 'flex'),
				(e.style.alignItems = 'center'),
				(e.style.justifyContent = 'center'),
				(e.style.padding = '40px');
			const i = document.createElement('button');
			(i.className = 'ubits-button ubits-button--primary ubits-button--md'),
				i.setAttribute('data-tooltip-trigger', 'true'),
				(i.innerHTML = '<span>Abrir Tooltip</span>'),
				(i.style.width = 'auto'),
				(i.style.zIndex = '1001'),
				e.appendChild(i);
			let o = null;
			const r = () => {
					const n = o && o.element.classList.contains('ubits-tooltip--open');
					i.querySelector('span').textContent = n ? 'Cerrar Tooltip' : 'Abrir Tooltip';
				},
				c = () => {
					if (o) {
						try {
							...
							console.error('Error al destruir tooltip:', a);
						}
						o = null;
					}
					document.querySelectorAll('.ubits-tooltip').forEach((a) => {
				...
				s = () => {
					...
					const n = i.getBoundingClientRect(),
						B = { top: n.top - 200 - 9, left: n.left + n.width / 2 };
					(o = b({
						title: t.title,
						showTitle: t.showTitle !== void 0 ? t.showTitle : !0,
						description: t.description,
						showDescription: t.showDescription !== void 0 ? t.showDescription : !0,
						width: t.width,
						tailPosition: t.tailPosition,
						tailOffset: t.tailOffset,
						primaryButtonLabel: t.primaryButtonLabel,
						showPrimaryButton: t.showPrimaryButton || !1,
						primaryButtonIcon: t.primaryButtonIcon,
						showPrimaryButtonIcon: t.showPrimaryButtonIcon || !1,
						secondaryButtonLabel: t.secondaryButtonLabel,
						showSecondaryButton: t.showSecondaryButton || !1,
						secondaryButtonIcon: t.secondaryButtonIcon,
						showSecondaryButtonIcon: t.showSecondaryButtonIcon || !1,
						tertiaryButtonLabel: t.tertiaryButtonLabel,
						showTertiaryButton: t.showTertiaryButton || !1,
						tertiaryButtonIcon: t.tertiaryButtonIcon,
						showTertiaryButtonIcon: t.showTertiaryButtonIcon || !1,
						onPrimaryAction: () => {
						...
						onClose: () => {
							t.onClose && t.onClose(), r();
						},
						open: !1,
						closeOnOutsideClick: t.closeOnOutsideClick !== void 0 ? t.closeOnOutsideClick : !0,
						position: B,
					})),
						o &&
							setTimeout(() => {
								...
								o.updatePosition({ top: u.top - h - 9, left: u.left + u.width / 2 });
							}, 0),
						r();
				},
				d = (n) => {
					if (
						(n.preventDefault(), n.stopPropagation(), !o || !o.element || !o.element.parentElement)
					) {
						s(),
							setTimeout(() => {
								o && (o.open(), r());
					...
					o.element.classList.contains('ubits-tooltip--open') ? o.close() : o.open(), r();
				};
			i.addEventListener('click', d);
			const y = () => {
				const n = o && o.element && o.element.classList.contains('ubits-tooltip--open');
				c(),
					setTimeout(() => {
						s(),
							n &&
			...
			let p = JSON.stringify({
				...
				primaryButtonIcon: t.primaryButtonIcon,
				showPrimaryButtonIcon: t.showPrimaryButtonIcon,
				secondaryButtonLabel: t.secondaryButtonLabel,
				showSecondaryButton: t.showSecondaryButton,
				secondaryButtonIcon: t.secondaryButtonIcon,
				showSecondaryButtonIcon: t.showSecondaryButtonIcon,
				tertiaryButtonLabel: t.tertiaryButtonLabel,
				showTertiaryButton: t.showTertiaryButton,
				tertiaryButtonIcon: t.tertiaryButtonIcon,
				showTertiaryButtonIcon: t.showTertiaryButtonIcon,
				closeOnOutsideClick: t.closeOnOutsideClick,
			});
			const m = setInterval(() => {
			...
			return (
				e.addEventListener('DOMNodeRemoved', () => {
					clearInterval(m), c();
				}),
				e
			);
...
const g = ['Default'];
export { l as Default, g as __namedExportsOrder, T as default };
