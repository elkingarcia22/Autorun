const u = {
		...
		parameters: {
			...
			docs: {
				description: {
					component:
						'Tokens de border-radius del sistema UBITS. Incluye valores desde none hasta full (circulo completo).',
				},
			},
		},
	},
...
function p(e) {
	const r = document.documentElement,
		i = getComputedStyle(r).getPropertyValue(e).trim(),
		o = document.createElement('div');
	(o.style.display = 'grid'),
		(o.style.gridTemplateColumns = '300px 1fr'),
		(o.style.alignItems = 'center'),
		(o.style.gap = '16px'),
		(o.style.padding = '12px 16px'),
		(o.style.border = '1px solid var(--modifiers-normal-color-light-border-1)'),
		(o.style.borderRadius = 'var(--ubits-border-radius-md, 8px)'),
		(o.style.background = 'var(--modifiers-normal-color-light-bg-1)'),
		(o.style.fontFamily = 'var(--modifiers-normal-body-md-regular-fontfamily)'),
		(o.style.color = 'var(--modifiers-normal-color-light-fg-1-high)');
	const n = document.createElement('code');
	(n.textContent = e),
		(n.style.fontSize = '13px'),
		(n.style.color = 'var(--modifiers-normal-color-light-fg-1-high)');
	const l = document.createElement('div');
	(l.style.display = 'flex'), (l.style.alignItems = 'center'), (l.style.gap = '12px');
	const t = document.createElement('div');
	(t.style.width = '80px'),
		(t.style.height = '80px'),
		(t.style.borderRadius = i || '0'),
		(t.style.background = 'var(--modifiers-normal-color-light-accent-brand)'),
		(t.style.border = '2px solid var(--modifiers-normal-color-light-border-1)'),
	...
	return (
		...
		(s.style.fontWeight = 'var(--weight-semibold, 600)'),
		l.appendChild(t),
		l.appendChild(s),
		o.appendChild(n),
		o.appendChild(l),
...
const d = {
		render: () => {
			...
			(e.style.display = 'flex'),
				...
				(e.style.borderRadius = 'var(--ubits-border-radius-md, 8px)'),
				(e.style.border = '1px solid var(--modifiers-normal-color-light-border-1)');
			const r = document.createElement('h3');
			return (
				(r.textContent = 'Border Radius - Todos los Tokens'),
				(r.style.color = 'var(--modifiers-normal-color-light-fg-1-high)'),
				(r.style.fontFamily = 'var(--modifiers-normal-heading-h3-fontfamily)'),
				(r.style.fontSize = 'var(--modifiers-normal-heading-h3-fontsize)'),
			...
			return (
				...
				[
					...
					(n.style.padding = '16px'),
						(n.style.background = 'var(--modifiers-normal-color-light-bg-1)'),
						(n.style.borderRadius = 'var(--ubits-border-radius-md, 8px)'),
						(n.style.border = '1px solid var(--modifiers-normal-color-light-border-1)');
					const l = document.createElement('code');
					(l.textContent = o.token),
						(l.style.display = 'block'),
						(l.style.marginBottom = '8px'),
						(l.style.fontSize = '13px'),
						(l.style.color = 'var(--modifiers-normal-color-light-fg-1-high)');
					const t = document.createElement('strong');
					(t.textContent = o.label),
						(t.style.display = 'block'),
						(t.style.marginBottom = '4px'),
						(t.style.fontSize = '14px'),
						(t.style.color = 'var(--modifiers-normal-color-light-fg-1-high)');
					const s = document.createElement('span');
					(s.textContent = o.use),
						(s.style.display = 'block'),
						(s.style.fontSize = '13px'),
						(s.style.color = 'var(--modifiers-normal-color-light-fg-1-medium)');
					const a = document.createElement('div');
					(a.style.width = '100px'),
						(a.style.height = '100px'),
						(a.style.background = 'var(--modifiers-normal-color-light-accent-brand)'),
						(a.style.borderRadius = `var(${o.token})`),
						(a.style.marginTop = '12px'),
						(a.style.border = '2px solid var(--modifiers-normal-color-light-border-1)'),
						n.appendChild(l),
						n.appendChild(t),
						n.appendChild(s),
						n.appendChild(a),
...
const b = ['TodosLosBorderRadius', 'EjemplosDeUso'];
export { m as EjemplosDeUso, d as TodosLosBorderRadius, b as __namedExportsOrder, u as default };
