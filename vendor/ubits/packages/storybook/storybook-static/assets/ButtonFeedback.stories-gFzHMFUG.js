import{c as P}from"./ModalProvider-Cwkz7B9R.js";import{c as j}from"./InputProvider-B1iJaViU.js";import{c as H,r as V}from"./ButtonProvider-Dmy-L2BE.js";import{s as E}from"./ToastProvider-CtZKLbxG.js";import"./iframe-BcZai5-G.js";import"./preload-helper-PPVm8Dsz.js";import"./ListProvider-Bx601uSc.js";import"./SpinnerProvider-o6XHV06V.js";function Q(d,i="regular"){const b=i==="regular"?"far":"fas",y=d.startsWith("fa-")?d:`fa-${d}`;return`<i class="${b} ${y}"></i>`}function N(d){const{containerId:i,text:b="",icon:y="comment-dots",position:r="bottom-right",offset:n=24,modalTitle:k="Deja tu Feedback",sectionOptions:c=[{value:"home",text:"Home"},{value:"encuestas",text:"Encuestas"}],defaultSection:p="",commentPlaceholder:q="¿Qué funciona bien? ¿Qué falta? ¿Qué mejorarías? ¿Qué necesita tu empresa?",n8nWebhookUrl:C,onFeedbackSent:B,visible:O=!0,className:_=""}=d;let x;i?x=document.getElementById(i)||document.body:x=document.body;let h=p||(c.length>0?c[0].value:""),f="",u=null,s="";const w=()=>{s=`ubits-button-feedback-form-${Math.random().toString(36).substr(2,9)}`;const g=V({variant:"secondary",size:"sm",icon:"times",iconStyle:"regular",iconOnly:!0,className:"ubits-button-feedback-modal__close"}),t=`
