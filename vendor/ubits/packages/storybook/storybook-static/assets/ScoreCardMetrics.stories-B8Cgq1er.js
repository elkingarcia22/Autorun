import{r as u}from"./ButtonProvider-Dmy-L2BE.js";import"./iframe-BcZai5-G.js";import"./ListProvider-Bx601uSc.js";import"./SpinnerProvider-o6XHV06V.js";import"./preload-helper-PPVm8Dsz.js";function M(s,t="regular",e){const a=t==="solid"?"fas":"far",o=s.startsWith("fa-")?s:`fa-${s}`,r=e?`style="color: ${e};"`:"";return`<i class="${a} ${o}" ${r}></i>`}function T(s){const e=Math.round(s),a=5-e;let o="";for(let r=0;r<e;r++){const i=r+1;o+=`
