import{r as k}from"./ButtonProvider-Dmy-L2BE.js";import{r as j}from"./ButtonAIProvider-CGOC_9a2.js";import{r as F}from"./StatusTagProvider-6gx2PeGG.js";import{c as R}from"./TooltipProvider-C3qYI4Ua.js";import{c as W}from"./ListProvider-Bx601uSc.js";import{c as Y,r as D}from"./BreadcrumbProvider-BQh42h2n.js";import"./iframe-BcZai5-G.js";import"./SpinnerProvider-o6XHV06V.js";import"./preload-helper-PPVm8Dsz.js";function U(t){const{title:i="",showTitle:g=!0,showBackButton:b=!1,showInfoButton:y=!1,showStatusTag:S=!1,statusTag:u,actions:B=[],showActions:N=!0,showBreadcrumb:A=!1,breadcrumb:T,className:V=""}=t,z=["ubits-header-section",V].filter(Boolean).join(" "),L=b?k({variant:"secondary",size:"md",icon:"arrow-left",iconStyle:"regular",iconOnly:!0,attributes:{"data-back-button":"true","aria-label":"Volver"}}):"",E=y?k({variant:"tertiary",size:"sm",icon:"circle-info",iconStyle:"regular",iconOnly:!0,attributes:{"data-info-button":"true","aria-label":"Información"}}):"",f=S&&u?F({...u,size:u.size||"sm",rightIcon:null}):"";let x="";g&&i?x=`
