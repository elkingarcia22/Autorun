import { r as o } from './SpinnerProvider-o6XHV06V.js';
...
const d = {
	...
	r = {
		args: { size: 'md', variant: 'primary', animated: !0, label: '', fullScreen: !1 },
		render: (t) => {
			...
			const a = o(t);
			return (e.innerHTML = a), n.appendChild(e), n;
		},
	};
r.parameters = {
	...r.parameters,
...
const p = ['Default'];
export { r as Default, p as __namedExportsOrder, d as default };
