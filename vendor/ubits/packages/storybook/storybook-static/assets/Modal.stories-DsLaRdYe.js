import { c as i } from './ModalProvider-Cwkz7B9R.js';
...
const u = {
		...
		argTypes: {
			...
			bodyContent: {
				control: { type: 'text' },
				description:
					'Contenido HTML del cuerpo del modal. Puede ser una cadena HTML o una función que devuelve HTML.',
				table: {
    ...
    `,
		...
		render: (e) => {
			...
			(o.className = 'ubits-button ubits-button--primary ubits-button--md'),
				(o.innerHTML = '<span>Abrir Modal</span>'),
				(o.style.width = 'auto'),
				...
				if (!n) {
					...
					e['footerButtons.tertiary.enabled'] &&
						...
						e['footerButtons.primary.enabled'] &&
							(a.primary = {
								label: e['footerButtons.primary.label'] || 'Aplicar',
								onClick: () => {},
							}),
						(n = i({
							title: e.title,
			...
			return o.addEventListener('click', r), t.appendChild(o), t;
		},
	};
l.parameters = {
	...l.parameters,
...
const y = ['Default'];
export { l as Default, y as __namedExportsOrder, u as default };
