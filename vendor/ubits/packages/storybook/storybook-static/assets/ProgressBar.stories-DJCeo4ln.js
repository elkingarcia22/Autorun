import { r as f } from './ProgressProvider-DCMY_PMl.js';
...
const b = {
    ...
    `);
			...
			(t.id = `progress-bar-container-${Date.now()}`),
				(t.style.cssText = `
      width: 100%;
      max-width: 500px;
    `);
			...
			const u = () => {
				...
				let o = {
					...
					value: e.value !== void 0 ? e.value : e.variant === 'default' ? 75 : 0,
					indicator: e.indicator !== void 0 ? e.indicator : !1,
				};
				if (e.variant === 'multi-color') {
					const n = e.numSegments || 4,
						r = [];
					n >= 1 &&
						r.push({
							value: e.segment1Value !== void 0 ? e.segment1Value : 30,
							color: e.segment1Color || 'info',
						}),
						n >= 2 &&
							r.push({
								value: e.segment2Value !== void 0 ? e.segment2Value : 25,
								color: e.segment2Color || 'yellow',
							}),
						n >= 3 &&
							r.push({
								value: e.segment3Value !== void 0 ? e.segment3Value : 20,
								color: e.segment3Color || 'green',
							}),
						n >= 4 &&
							r.push({
								value: e.segment4Value !== void 0 ? e.segment4Value : 25,
								color: e.segment4Color || 'error',
							}),
						n >= 5 &&
							r.push({
								value: e.segment5Value !== void 0 ? e.segment5Value : 0,
								color: e.segment5Color || 'gray',
							}),
						(o.segments = r),
						(o.value = void 0);
				}
				try {
					const n = f(o);
					t.innerHTML = n;
					const r = t.querySelector('.ubits-progress-bar');
					r &&
						(a = {
							element: r,
							destroy: () => {
			...
			const p = () => {
				if ((l && (clearInterval(l), (l = null)), (t.innerHTML = ''), a))
					try {
						a.destroy();
					} catch {}
			};
			return (
				i.addEventListener('DOMNodeRemoved', p),
				s.appendChild(c),
				s.appendChild(g),
				s.appendChild(t),
				i.appendChild(s),
...
const V = ['Default'];
export { m as Default, V as __namedExportsOrder, b as default };
