import { r as u } from './ToggleProvider-tayloMCw.js';
	...
	a = {
		...
		render: (e) => {
			...
			const o = () => {
				...
				t.innerHTML = n;
				const l = t.querySelector('.ubits-toggle__input');
				l &&
					l.addEventListener('change', (c) => {
						const m = c.target;
						(e.checked = m.checked), e.onChange && e.onChange(c);
					});
			};
			o();
...
const f = ['Default'];
export { a as Default, f as __namedExportsOrder, b as default };
