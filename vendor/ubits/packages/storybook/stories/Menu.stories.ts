...
import type {
	...
	MenuItem,
	MenuUserInfo,
} from '../../addons/menu/src/types/MenuOptions';
	...
	if (args.section2Title) {
		...
		if (args.section2Item2Label) {
			section2Items.push({
				...
				badge:
					args.section2Item2Badge && args.section2Item2Badge > 0
						? {
								content: args.section2Item2Badge,
								variant: args.section2Item2BadgeVariant || 'error',
							}
						: undefined,
...
export const Default: Story = {
    ...
    `;
		...
		const userInfo: MenuUserInfo | undefined =
			args.userAvatarImage && args.userName && args.userRole
				? {
