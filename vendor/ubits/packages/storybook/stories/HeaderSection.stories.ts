...
import type {
	...
	HeaderSectionAction,
} from '../../addons/header-section/src/types/HeaderSectionOptions';
		...
		requestAnimationFrame(() => {
			try {
				const statusTagOptions =
					(args as any).showStatusTag && (args as any).statusTagLabel
						? {
				...
				const breadcrumbOptions =
					(args as any).showBreadcrumb && (args as any).breadcrumbItems
						? {
