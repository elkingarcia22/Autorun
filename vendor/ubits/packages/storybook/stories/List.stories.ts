			...
			if (listElement && scrollbarContainer) {
				...
				if (typeof (window as any).createScrollbarLocal === 'function') {
					if (listElement.scrollHeight > listElement.clientHeight) {
						const scrollbarInstance = (window as any).createScrollbarLocal(
							listElement,
							scrollbarContainer,
							'vertical',
						);
						if (scrollbarInstance) {
							...
							setTimeout(() => {
								const scrollbarElement = scrollbarContainer.querySelector(
									'.ubits-scrollbar',
								) as HTMLElement;
								const barElement = scrollbarContainer.querySelector(
									'.ubits-scrollbar__bar',
								) as HTMLElement;
					...
					import('../../addons/scroll/src/ScrollProvider')
						.then(({ createScrollbar }) => {
							if (listElement.scrollHeight > listElement.clientHeight) {
