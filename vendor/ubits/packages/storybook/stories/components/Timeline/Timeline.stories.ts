...
const timelineHTML = \`
  <div class="ubits-timeline ubits-timeline--left" id="timeline-1">
    <div class="ubits-timeline-item" data-index="0" data-state="filled">
      <div class="ubits-timeline-item__marker-container">
        <div class="ubits-timeline-marker ubits-timeline-marker--filled" style="
...
// Insertar avatar en el marcador:
// <div class="ubits-timeline-marker ubits-timeline-marker--avatar">
//   ${avatarHTML}
// </div>
