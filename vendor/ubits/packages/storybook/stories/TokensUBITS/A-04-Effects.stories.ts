...
export const Elevation: Story = {
	render: () => {
		...
		const defaultPreview = createShadowPreview(
			'Default',
		...
		const hoverPreview = createShadowPreview(
			'Hover',
...
export const Focus: Story = {
	render: () => {
		...
		const focusPreview = createShadowPreview(
			'Focus',
...
export const Floating: Story = {
	render: () => {
		...
		const floating0Blur =
			parseFloat(getToken('--modifiers-normal-elevation-floating-0-blur')) || 28.8;
		const floating0Spread =
			parseFloat(getToken('--modifiers-normal-elevation-floating-0-spread')) || 0;
		...
		const floating1Spread =
			parseFloat(getToken('--modifiers-normal-elevation-floating-1-spread')) || 0;
		...
		const floatingPreview = createShadowPreview(
			'Floating',
			combinedShadow,
			floating0X,
			floating0Y,
