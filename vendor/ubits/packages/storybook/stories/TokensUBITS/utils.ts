...
export function createColorSwatch(
	...
	const { showValue = true, showVariable = true, width = '120px', height = '28px' } = options;
 ...
 */
export function createLightDarkComparison(tokens: string[], title?: string): HTMLElement {
	const container = document.createElement('div');
	container.style.display = 'grid';
