...
export const Default: Story = {
	...
	render: (args) => {
		...
		const updateButtonText = () => {
			const isOpen =
				popoverInstance && popoverInstance.element.classList.contains('ubits-popover--open');
		...
		const recreatePopover = () => {
			const wasOpen =
				popoverInstance &&
				popoverInstance.element &&
				popoverInstance.element.classList.contains('ubits-popover--open');
			destroyPopover();
