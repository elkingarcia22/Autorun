...
import type {
	AccordionOptions,
	AccordionItem,
} from '../../addons/accordion/src/types/AccordionOptions';
...
const itemsWithSubHeaders: AccordionItem[] = [
	...
	},
	{
		...
		content:
			'Configure how and when you receive notifications. Choose from email, push, or in-app notifications for different types of events.',
	},
	{
		id: '3',
		...
		content:
			'Enable two-factor authentication to protect your account with an additional security layer. You can use an authenticator app or SMS for verification.',
	},
	{
		id: '4',
		...
		content:
			'Get in touch with our support team for any questions or issues. We offer 24/7 support via email, chat, or phone.',
	},
];
