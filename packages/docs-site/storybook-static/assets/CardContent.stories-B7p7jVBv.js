    ...
    <div class="course-card" data-progress="${e.progress}" data-status="${e.status}">
      ...
      <div class="course-content">
        ...
        <div class="course-specs">
          <div class="spec-item">
            <div class="spec-icon">
              ${n(i.replace("far ","").replace("fas ",""),i.startsWith("far")?"regular":"solid")}
            </div>
...
}`,...o.parameters?.docs?.source}}};const f=["Default"];export{o as Default,f as __namedExportsOrder,b as default};
