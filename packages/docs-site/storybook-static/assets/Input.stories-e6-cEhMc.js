...
import{_ as F}from"./preload-helper-PPVm8Dsz.js";import{c as q,r as A}from"./ListProvider-rXce0ADx.js";import"./iframe-CHGeu5ha.js";function j(e){const{containerId:t,label:n="",placeholder:i="",helperText:o="",size:r="md",state:c="default",type:l="text",showLabel:f=!0,showHelper:d=!1,showCounter:g=!1,maxLength:s=50,mandatory:b=!1,mandatoryType:x="obligatorio",leftIcon:a="",rightIcon:v="",value:p="",className:w="",attributes:$={}}=e;let u="";if(f&&n){const y=b?` <span class="ubits-input-mandatory">(${x})</span>`:"";u+=`<label class="ubits-input-label">${n}${y}</label>`}const m=a&&a.trim()!=="",L=v&&v.trim()!=="";m&&a.startsWith("fa-")?`${a}`:m&&`${a}`,L&&v.startsWith("fa-")?`${v}`:L&&`${v}`,u+='<div style="position: relative; display: inline-block; width: 100%;">';let C=v,T=L,M=a,P=m;const k=["ubits-input",`ubits-input--${r}`];c!=="default"&&k.push(`ubits-input--${c}`),w&&k.push(w);const E=c==="disabled"?" disabled":"",z=g?` maxlength="${s}"`:"",H=m?r==="xs"?"padding-left: 32px;":r==="sm"?"padding-left: 36px;":r==="md"?"padding-left: 40px;":"padding-left: 44px;":"",S=L?r==="xs"?"padding-right: 32px;":r==="sm"?"padding-right: 36px;":r==="md"?"padding-right: 40px;":"padding-right: 44px;":"";if(l==="select"){const y=e.selectOptions||[],h=p&&y.find(I=>I.value===p)?.text||i;u+=`<input type="text" class="${k.join(" ")}" style="width: 100%; ${H} ${S}" value="${h}" readonly>`,L||(C="fa-chevron-down",T=!0)}else if(l==="textarea"){let y=`width: 100%; min-height: 80px; resize: vertical; ${H} ${S}`;c==="disabled"&&(y+="; background: var(--ubits-bg-3) !important; color: var(--ubits-fg-1-low) !important; border-color: var(--ubits-border-2) !important;"),u+=`<textarea class="${k.join(" ")}" style="${y}" placeholder="${i}"${E}${z}>${p}</textarea>`}else if(l==="search"){let y=H,h=S;m||(M="fa-search",P=!0,y=r==="xs"?"padding-left: 32px;":r==="sm"?"padding-left: 36px;":r==="md"?"padding-left: 40px;":"padding-left: 44px;"),C="fa-times",T=!0,h=r==="xs"?"padding-right: 32px;":r==="sm"?"padding-right: 36px;":r==="md"?"padding-right: 40px;":"padding-right: 44px;";let I=`width: 100%; ${y} ${h}`;c==="disabled"&&(I+="; background: var(--ubits-bg-3) !important; color: var(--ubits-fg-1-low) !important; border-color: var(--ubits-border-2) !important;"),u+=`<input type="text" class="${k.join(" ")}" style="${I}" placeholder="${i}" value="${p}" autocomplete="off"${E}${z}>`}else if(l==="autocomplete"){let y=H,h=S;m||(M="fa-search",P=!0,y=r==="xs"?"padding-left: 32px;":r==="sm"?"padding-left: 36px;":r==="md"?"padding-left: 40px;":"padding-left: 44px;"),C="fa-times",T=!0,h=r==="xs"?"padding-right: 32px;":r==="sm"?"padding-right: 36px;":r==="md"?"padding-right: 40px;":"padding-right: 44px;";let I=`width: 100%; ${y} ${h}`;c==="disabled"&&(I+="; background: var(--ubits-bg-3) !important; color: var(--ubits-fg-1-low) !important; border-color: var(--ubits-border-2) !important;"),u+=`<input type="text" class="${k.join(" ")}" style="${I}" placeholder="${i}" value="${p}" autocomplete="off"${E}${z}>`}else if(l==="calendar"){let y=H,h=S;C="fa-calendar",T=!0,h=r==="xs"?"padding-right: 32px;":r==="sm"?"padding-right: 36px;":r==="md"?"padding-right: 40px;":"padding-right: 44px;";let I=`width: 100%; ${y} ${h}`;c==="disabled"&&(I+="; background: var(--ubits-bg-3) !important; color: var(--ubits-fg-1-low) !important; border-color: var(--ubits-border-2) !important;"),u+=`<input type="text" class="${k.join(" ")}" style="${I}" placeholder="${i}" value="${p}" readonly${E}>`}else if(l==="password"){let y=H,h=S;C="fa-eye",T=!0,h=r==="xs"?"padding-right: 32px;":r==="sm"?"padding-right: 36px;":r==="md"?"padding-right: 40px;":"padding-right: 44px;";let I=`width: 100%; ${y} ${h}`;c==="disabled"&&(I+="; background: var(--ubits-bg-3) !important; color: var(--ubits-fg-1-low) !important; border-color: var(--ubits-border-2) !important;"),u+=`<input type="password" class="${k.join(" ")}" style="${I}" placeholder="${i}" value="${p}"${E}${z}>`}else u+=`<input type="${l}" class="${k.join(" ")}" style="width: 100%; ${H} ${S}" placeholder="${i}" value="${p}"${E}${z}>`;if(P){const y=M.startsWith("fa-")?`far ${M}`:`far fa-${M}`;u+=`<i class="${y} ubits-input-icon-left" style="position: absolute; left: 12px; top: 50%; transform: translateY(-50%); color: var(--ubits-fg-1-medium); pointer-events: none; z-index: 1;"></i>`}if(T){const y=C.startsWith("fa-")?`far ${C}`:`far fa-${C}`;u+=`<i class="${y} ubits-input-icon-right" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: var(--ubits-fg-1-medium); pointer-events: none; z-index: 1;"></i>`}u+="</div>",(d||g)&&(u+='<div class="ubits-input-helper">',d&&o&&(u+=`<span>${o}</span>`),g&&(u+=`<span class="ubits-input-counter">0/${s}</span>`),u+="</div>");const V=Object.entries($).map(([y,h])=>`${y}="${h}"`).join(" ");return V?`<div ${V}>${u}</div>`:u}function N(e){const{containerId:t,onChange:n,onFocus:i,onBlur:o,showCounter:r=!1,maxLength:c=50,type:l="text",selectOptions:f=[],autocompleteOptions:d=[],value:g=""}=e;if(!t)return console.error("UBITS Input: containerId es requerido"),null;const s=document.getElementById(t);if(!s)return console.error(`UBITS Input: No se encontró el contenedor con ID "${t}"`),null;const b=j(e);s.innerHTML=b;const x=s.querySelector('div[style*="position: relative"]'),a=s.querySelector(".ubits-input"),v=s.querySelector(".ubits-input-counter");if(!a||!x)return console.error("UBITS Input: No se pudo crear el elemento input"),null;if(getComputedStyle(s).position==="static"&&(s.style.position="relative"),l==="select"&&_(s,a,f,g,e.placeholder||"",n,e.size||"md"),l==="search"&&R(s,a,n),l==="autocomplete"&&U(s,a,d,n,e.size||"md"),l==="calendar"&&W(s,a,n),l==="password"&&B(s,a),r&&v&&Y(a,v,c),n&&typeof n=="function"){const p=l==="select"?"change":"input";a.addEventListener(p,w=>{n(w.target.value,w)})}return i&&typeof i=="function"&&a.addEventListener("focus",p=>{i(p.target.value,p)}),o&&typeof o=="function"&&a.addEventListener("blur",p=>{o(p.target.value,p)}),{element:x,inputElement:a,getValue:()=>a.value,setValue:p=>{a.value=p,r&&v&&O(v,p.length,c)},focus:()=>a.focus(),blur:()=>a.blur(),disable:()=>{a.disabled=!0,a.classList.add("ubits-input--disabled")},enable:()=>{a.disabled=!1,a.classList.remove("ubits-input--disabled")},setState:p=>{["ubits-input--hover","ubits-input--focus","ubits-input--active","ubits-input--invalid","ubits-input--disabled"].forEach($=>a.classList.remove($)),p!=="default"&&a.classList.add(`ubits-input--${p}`),p==="disabled"?a.disabled=!0:a.disabled=!1}}}function B(e,t){const n=e.querySelector('i[class*="fa-eye"]');if(n){let i=!1;n.style.pointerEvents="auto",n.style.cursor="pointer",n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),i=!i,i?(t.type="text",n.className="far fa-eye-slash ubits-input-icon-right"):(t.type="password",n.className="far fa-eye ubits-input-icon-right")})}}function R(e,t,n){const i=e.querySelector('i[class*="fa-times"]');if(i){i.style.display=t.value.length>0?"block":"none",i.style.pointerEvents="auto",i.style.cursor="pointer";const o=()=>{i.style.display=t.value.length>0?"block":"none"};t.addEventListener("input",o),i.addEventListener("click",r=>{r.preventDefault(),t.value="",t.focus(),o(),n&&n("")})}}function U(e,t,n,i,o="md"){const r=o==="xs"?"xs":o==="sm"?"sm":o==="md"?"md":"lg",c=e.querySelector('i[class*="fa-times"]');if(c){c.style.display=t.value.length>0?"block":"none",c.style.pointerEvents="auto",c.style.cursor="pointer";const d=()=>{c.style.display=t.value.length>0?"block":"none"};t.addEventListener("input",d),c.addEventListener("click",g=>{g.preventDefault(),t.value="",t.focus(),d();const s=e.querySelector(".ubits-autocomplete-list-container");s&&(s.style.display="none"),i&&i("")})}const l=document.createElement("div");l.className="ubits-autocomplete-list-container",l.style.cssText=`
    position: absolute;
    top: 100%;
    left: 0;
    right: 0;
