import{c as g}from"./ScrollProvider-DeKjMEqs.js";import"./iframe-Cv55Ao8S.js";import"./preload-helper-PPVm8Dsz.js";const I={title:"Components/Scrollbar",tags:["autodocs"],parameters:{docs:{description:{component:"Componente Scrollbar personalizado UBITS. Se usa para crear scrollbars personalizados en elementos scrollable. Soporta orientación vertical y horizontal. Se sincroniza automáticamente con el elemento scrollable asociado. Aparece en hover y se adapta al tamaño del contenido. Soporta arrastrar y clic para navegar."}},layout:"fullscreen"},argTypes:{orientation:{control:{type:"select"},options:["vertical","horizontal"],description:"Orientación del scrollbar (vertical u horizontal).",table:{type:{summary:"string"},defaultValue:{summary:"vertical"},category:"Apariencia"}},state:{control:{type:"select"},options:["default"],description:"Estado del scrollbar.",table:{type:{summary:"string"},defaultValue:{summary:"default"},category:"Estado"}}}},x={args:{orientation:"vertical",state:"default"},render:(a,{updateArgs:E})=>{const u=document.createElement("div");u.style.cssText=`
      width: 100vw;
      height: 100vh;
      display: flex;
      align-items: center;
    ...
    `;let i=null,n=null;const y=v=>{if(i&&(i.destroy(),i=null),n&&n.remove(),n=document.createElement("div"),v==="vertical"){n.style.cssText=`
          display: flex;
          align-items: stretch;
          gap: 8px;
          width: 600px;
        ...
        `;for(let o=1;o<=30;o++){const p=document.createElement("div");p.style.cssText=`
          ...
          `;const m=document.createElement("p");m.textContent=`Elemento ${o}`,m.style.cssText=`
            ...
            color: var(--ubits-fg-1-high, #303a47);
            font-size: var(--font-body-sm-size, 13px);
          `,p.appendChild(m),d.appendChild(p)}r.appendChild(s),r.appendChild(c),r.appendChild(d),e.appendChild(r);const l=document.createElement("div");l.id=`scrollbar-container-vertical-${Date.now()}`,l.style.cssText=`
          height: 100%;
        `,n.appendChild(e),n.appendChild(l),setTimeout(()=>{try{i=g({orientation:"vertical",state:a.state,targetId:e.id,containerId:l.id})}catch(o){console.error("Error al crear scrollbar:",o)}},100)}else{n.style.cssText=`
          display: flex;
          flex-direction: column;
          gap: 8px;
          width: 600px;
        ...
        `;for(let o=1;o<=20;o++){const p=document.createElement("div");p.style.cssText=`
          ...
          `;const m=document.createElement("p");m.textContent=`Elemento ${o}`,m.style.cssText=`
            ...
            color: var(--ubits-fg-1-high, #303a47);
            font-size: var(--font-body-sm-size, 13px);
          `,p.appendChild(m),d.appendChild(p)}r.appendChild(s),r.appendChild(c),r.appendChild(d),e.appendChild(r);const l=document.createElement("div");l.id=`scrollbar-container-horizontal-${Date.now()}`,l.style.cssText=`
          width: 100%;
        `,n.appendChild(e),n.appendChild(l),setTimeout(()=>{try{i=g({orientation:"horizontal",state:a.state,targetId:e.id,containerId:l.id})}catch(o){console.error("Error al crear scrollbar:",o)}},100)}f.appendChild(n)};y(a.orientation),new MutationObserver(()=>{a.orientation&&n&&(n.querySelector('[id*="scrollbar-target-vertical"]')?"vertical":"horizontal")!==a.orientation&&y(a.orientation)});let h=a.orientation;const C=setInterval(()=>{a.orientation!==h&&(h=a.orientation,y(a.orientation))},100);return u.addEventListener("DOMNodeRemoved",()=>{clearInterval(C),i&&i.destroy()}),u.appendChild(f),u}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...x.parameters?.docs?.source}}};const S=["Default"];export{x as Default,S as __namedExportsOrder,I as default};
