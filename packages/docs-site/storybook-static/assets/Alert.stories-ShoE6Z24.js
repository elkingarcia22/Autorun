const l={success:"fa-check-circle",info:"fa-info-circle",warning:"fa-exclamation-triangle",error:"fa-times-circle"};function c(e,n="regular"){const s=n==="solid"?"fas":"far",a=e.startsWith("fa-")?e:`fa-${e}`;return`<i class="${s} ${a}"></i>`}function d(e={}){const{type:n="success",message:s="",closable:a=!0,className:t=""}=e,r=l[n]||l.success;return`
    <div class="${["ubits-alert",`ubits-alert--${n}`,!a&&"ubits-alert--no-close",t].filter(Boolean).join(" ")}" role="alert" aria-live="polite">
      ...
      <div class="ubits-alert__content">
        <div class="ubits-alert__text">${s}</div>
      </div>
      ${a?`
