function m(e={}){const{label:n="",size:l="md",state:t="default",leftIcon:s,rightIcon:a,clickable:o=!1,closable:c=!1,className:d=""}=e,p=["ubits-chip",`ubits-chip--${l}`,t!=="default"?`ubits-chip--${t}`:"",o?"ubits-chip--clickable":"",c?"ubits-chip--closable":"",d].filter(Boolean).join(" "),u=s?`<span class="ubits-chip__left-icon" aria-hidden="true"><i class="far fa-${s}"></i></span>`:"",b=c||a?`<button class="ubits-chip__right-icon" type="button" aria-label="Cerrar chip" ${t==="disabled"?"disabled":""}>
