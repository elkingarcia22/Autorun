import"./iframe-DpxOG777.js";import"./preload-helper-PPVm8Dsz.js";function x(e){const{title:t,complementaryText:r,width:i=40,bodyContent:s="",footerButtons:o,className:a=""}=e,d=["ubits-drawer",`ubits-drawer--width-${i}`,a].filter(Boolean).join(" "),b=`
...
}`,...y.parameters?.docs?.source}}};const C=["Default"];export{y as Default,C as __namedExportsOrder,h as default};
