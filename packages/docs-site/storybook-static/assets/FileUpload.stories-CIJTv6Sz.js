import"./iframe-Cv55Ao8S.js";import"./preload-helper-PPVm8Dsz.js";function C(e){if(e===0)return"0 B";const n=1024,i=["B","KB","MB","GB"],a=Math.floor(Math.log(e)/Math.log(n));return Math.round(e/Math.pow(n,a)*100)/100+" "+i[a]}function w(e={}){const{state:n="default",fileName:i,fileExtension:a,fileSize:s,showFileSize:t=!0,showActions:r=!0,uploadText:f="Haz clic para subir archivo",fileStatus:u="pending",className:l=""}=e,v=["ubits-file-upload",`ubits-file-upload--${n}`,l].filter(Boolean).join(" ");let p="var(--ubits-border-1, #d0d2d5)",o="var(--ubits-bg-1, #ffffff)",d="var(--ubits-fg-1-medium, #5c646f)";n==="dragging"?p="var(--ubits-accent-brand-static-inverted, #0c5bef)":n==="error"?p="var(--ubits-feedback-accent-error, #e9343c)":n==="disabled"?(o="var(--ubits-bg-disabled, #edeeef)",p="var(--ubits-border-disabled, #e1e2e5)",d="var(--ubits-fg-on-disabled, #8d9199)"):n==="filled"&&(p="var(--ubits-border-1, #d0d2d5)",o="var(--ubits-bg-2, #f3f3f4)",d="var(--ubits-fg-1-high, #303a47)");let c="";n==="filled"?c=`
