const g=["--ubits-fg-rose-subtle","--ubits-fg-rose-subtle-inverted","--ubits-fg-rose-subtle-hover","--ubits-fg-rose-subtle-inverted-hover","--ubits-fg-rose-subtle-static","--ubits-fg-rose-subtle-static-inverted","--ubits-fg-rose-subtle-static-hover","--ubits-fg-rose-subtle-static-inverted-hover"],h={title:"Tokens/Colors/Rose Foregrounds",tags:["autodocs"]};function u(n,d){const r=document.documentElement;document.body.setAttribute("data-theme",d);const e=getComputedStyle(r).getPropertyValue(n).trim(),s=/^(#fff(f)?|rgb\(255,\s*255,\s*255\))$/i.test(e)?"repeating-conic-gradient(#eee 0% 25%, var(--ubits-bg-1) 0% 50%) 50%/12px 12px":e,t=document.createElement("div");t.style.display="grid",t.style.gridTemplateColumns="340px 1fr",t.style.alignItems="center",t.style.gap="8px",t.style.padding="6px 8px",t.style.border="1px solid #e5e7eb",t.style.borderRadius="8px";const c=document.createElement("code");c.textContent=n;const l=document.createElement("div");l.style.height="28px",l.style.width="120px",l.style.borderRadius="6px",l.style.border="1px solid #9ca3af",l.style.background=s;const p=document.createElement("code");p.textContent=e;const o=document.createElement("div");return o.style.display="flex",o.style.gap="8px",o.style.alignItems="center",o.appendChild(l),o.appendChild(p),t.appendChild(c),t.appendChild(o),t}const a={render:()=>{const n=document.createElement("div");n.style.display="grid",n.style.gridTemplateColumns="1fr 1fr",n.style.gap="16px";const d=document.createElement("div");d.style.background="#ffffff",d.style.border="1px solid #e5e7eb",d.style.borderRadius="10px",d.style.padding="12px";const r=document.createElement("h4");r.textContent="Light",d.appendChild(r);const e=document.createElement("div");e.style.background="#0E1825",e.style.color="#edeeef",e.style.border="1px solid #0E1825",e.style.borderRadius="10px",e.style.padding="12px";const i=document.createElement("h4");return i.textContent="Dark",e.appendChild(i),g.forEach(s=>{d.appendChild(u(s,"light")),e.appendChild(u(s,"dark"))}),n.appendChild(d),n.appendChild(e),document.body.setAttribute("data-theme","light"),n}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: () => {
