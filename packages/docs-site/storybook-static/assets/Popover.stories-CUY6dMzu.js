import"./iframe-Qhh1jVCN.js";import"./preload-helper-PPVm8Dsz.js";const C={sm:"240px",md:"360px",lg:"400px",xl:"480px"};function P(e){const{title:l,bodyContent:i="",width:n="md",tailPosition:u="top",tailOffset:r=0,footerButtons:p,className:m=""}=e,v=C[n]||C.md,t=`ubits-popover--width-${n}`,y=`ubits-popover--tail-${u}`,s=["ubits-popover",t,y,m].filter(Boolean).join(" "),a=`
