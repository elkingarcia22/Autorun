function v(e){const{label:t,complementaryText:o,value:s,name:r,checked:a=!1,size:i="md",state:n="default",disabled:l=!1,className:c=""}=e,u=l||n==="disabled",m=["ubits-radio-button",`ubits-radio-button--${i}`,n!=="default"?`ubits-radio-button--${n}`:"",a?"ubits-radio-button--checked":"",u?"ubits-radio-button--disabled":"",c].filter(Boolean).join(" "),p=`
    <input
      type="radio"
      id="radio-${r}-${s}"
      name="${r}"
  ...
  `,b=`
    <span class="ubits-radio-button__circle" aria-hidden="true">
      ${a||n==="active"&&!a?'<span class="ubits-radio-button__dot"></span>':""}
    </span>
  `,y=`
    <span class="ubits-radio-button__label">${t}</span>
  `,g=o?`<span class="ubits-radio-button__complementary-text">${o}</span>`:"",f=`
...
}`,...d.parameters?.docs?.source}}};const x=["Default"];export{d as Default,x as __namedExportsOrder,h as default};
