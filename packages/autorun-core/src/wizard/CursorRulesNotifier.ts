...
📋 Archivos de reglas principales:
   • .cursorrules (Cursor lo lee automáticamente) - ⭐ Simplificado (236 líneas)
   • QUICK-REFERENCE.md - ⭐ NUEVO: Referencia rápida
   • .cursor/rules/00-inicio.md - ⭐ Verificación inicial
   • .cursor/rules/01-deteccion-imagen.md - ⭐ Detección de imágenes
   • .cursor/rules/02-bloqueo-imagen.md - ⭐ Bloqueo para imágenes
   ...
   • .cursor/rules/06-implementacion-automatica.md - ⭐ Implementación automática
