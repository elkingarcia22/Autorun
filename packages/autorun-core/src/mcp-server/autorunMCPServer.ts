...
export async function startAutorunMCPServer() {
		...
		return {
			tools: [
						...
						properties: {
							...
							options: {
								...
								properties: {
									...
									dryRun: {
										type: 'boolean',
										description: 'Ejecutar sin escribir archivos (solo simular)',
									},
									skipFormatting: {
										type: 'boolean',
									...
									runVisualTests: {
										type: 'boolean',
										description: 'Ejecutar tests visuales con Chromatic (opcional)',
									},
								},
							},
						},
						...
						properties: {
							...
							options: {
								...
								properties: {
									strict: {
										type: 'boolean',
										description: 'Modo estricto: errores en lugar de advertencias',
									},
									checkAutorunMarks: {
										type: 'boolean',
				...
				},
				{
					...
					description: 'Obtiene checklist de implementación para un componente específico',
					inputSchema: {
						type: 'object',
						properties: {
							componentName: {
	...
	server.setRequestHandler(CallToolRequestSchema, async (request) => {
		...
		try {
			...
			console.error(`✅ [Autorun MCP Server] Tool ${name} completado exitosamente`);
			...
			console.error(`❌ [Autorun MCP Server] Error en tool ${name}: ${error.message}`);
