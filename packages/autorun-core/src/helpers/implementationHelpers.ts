...
export function detectComponentFromMessage(message: string): string | null {
  const patterns = [
    ...
    // ⚠️ MEJORADO: Detección de Button con más patrones
    {
      pattern:
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:drawer|caj[oó]n\s+lateral|panel\s+lateral)/i,
      component: 'Drawer',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:checkbox|casilla)/i,
      component: 'Checkbox',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:radio|bot[oó]n\s+de\s+opci[oó]n)/i,
      component: 'Radio',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:datepicker|date-picker|selector\s+de\s+fecha|calendario)/i,
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:toast|notificaci[oó]n|aviso\s+temporal)/i,
      component: 'Toast',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:alert|alerta|aviso)/i,
      component: 'Alert',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:tooltip|informaci[oó]n\s+adicional)/i,
      component: 'Tooltip',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:accordion|acorde[oó]n)/i,
      component: 'Accordion',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:breadcrumb|migas\s+de\s+pan)/i,
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:pagination|paginaci[oó]n)/i,
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:file\s+upload|subir\s+archivo|carga\s+de\s+archivo)/i,
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:calendar|calendario)/i,
      component: 'Calendar',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:switch|toggle|interruptor)/i,
      component: 'Switch',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:slider|deslizador|rango)/i,
      component: 'Slider',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:chip|etiqueta\s+peque[ñn]a)/i,
      component: 'Chip',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:skeleton|esqueleto|placeholder)/i,
      component: 'Skeleton',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:spinner|cargador|loading)/i,
      component: 'Spinner',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:progress|barra\s+de\s+progreso)/i,
      component: 'Progress',
      priority: 7,
    },
    {
    ...
    {
      pattern: /(?:implementar|crear|agregar|poner|hacer).*(?:rating|calificaci[oó]n|estrellas)/i,
      component: 'Rating',
      priority: 7,
    },
    {
