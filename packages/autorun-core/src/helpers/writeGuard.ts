...
import { autoInterceptWrite, AutoWriteInterceptorResult } from './autoWriteInterceptor';
...
export async function guardWrite(
	...
	console.log(`   import { interceptedWrite } from '@autorun/core/interceptors/toolInterceptors';`);
