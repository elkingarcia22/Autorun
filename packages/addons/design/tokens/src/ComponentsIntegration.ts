 ...
 * 
 * Integración del sistema de componentes con window.Autoframe
...
/**
 * Interfaz para el objeto global Autoframe.Components
 */
export interface AutoframeComponentsAPI {
  /**
...
export function initializeComponentsIntegration(): void {
  ...
  const componentsAPI: AutoframeComponentsAPI = {
  ...
  // Exponer API global
  (window as any).Autoframe.Components = componentsAPI;
