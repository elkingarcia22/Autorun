...
console.log('data-view exports:', {
	renderDataView: typeof renderDataView,
	createDataView: typeof createDataView,
});
console.log('slider exports:', {
	renderSlider: typeof renderSlider,
	createSlider: typeof createSlider,
	SliderAddon: typeof SliderAddon,
});
